...
public class FleetComposite extends Composite {
    ...
    public void updateFleet(DockDto dock) {
        ...
        for (int i = 0; i < ships.size(); i++) {
            ...
            // 装備索敵値計（電探：１倍；偵察機：２倍）
            totalSakuteki25 += ship.getSakuteki25();
        ...
        // 2-5公式索敵
        this.addStyledText(this.message, MessageFormat.format(AppConstants.MESSAGE_SAKUTEKI25, totalSakuteki25), null);
        // 合計Lv
